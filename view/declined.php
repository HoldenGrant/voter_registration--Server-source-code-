...
<head>
    ...
    <title>List of Declined Applicants</title>
...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Declined Applicants</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Declined Applicants DataTables
                            <div class="panel-body" style="float:right; margin-top:-23px;"></div>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php include 'declined_table.php'; ?> 
                                </table>
                            </div>
                        </div>
                    </div>
